...
@section('content-header')
    <h1>
        {{ trans('blog::tags.title.tags') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('blog::tags.title.tags') }}</li>
    </ol>
@stop
            ...
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.blog.tag.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('blog::tags.button.create tag') }}
                    </a>
                </div>
            </div>
...
@section('shortcuts')
    <dl class="dl-horizontal">
        <dt><code>c</code></dt>
        <dd>{{ trans('blog::tags.title.create tag') }}</dd>
    </dl>
@stop
